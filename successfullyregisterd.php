...
$url = "eventmanagement2315.000webhostapp.com/success.php?txnid=".$txnid."eventid=".$eventid;
...
if($minimum == 0){
    $sql = "select email, name from singleevent_registration where txn_id ='$txnid'";
$result = mysqli_query($conn,$sql);
...
mail($to_email,$subject,$message,$headers);
    ...
    $sql = "select emails, team_name from teamevent_registration where txn_id ='$txnid'";
$result = mysqli_query($conn,$sql);
